...
#define DOCKING_WHEEL_LOW_SPEED 200                 //Speed for the slower wheel when docking
#define DOCKING_TIME_TO_SLOW_SPEED 500             //Time used for the slower wheel to slow down to its target speed
#define DOCKING_TIME_TO_HIGH_SPEED 100               //Time used for the fast wheel to speed up to its target speed
